    ...
    <footer className="bg-[#1C1E1F] border-t border-white/[0.06]">
      ...
      <div className="border-t border-white/[0.05]">
        <div className="section-container py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          >
            &copy;GT Group {currentYear} — Exclusive BYD Dealer in Georgia.{" "}
            {t("rights")}
          </p>
          <div className="flex items-center gap-4">
            <Link
              href="/contact"
              className="text-xs text-white/25 hover:text-white/50 transition-colors duration-200 font-light"
            >
