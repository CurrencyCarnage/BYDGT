  ...
  return (
    <div className="p-8">
      <nav className="flex items-center gap-2 text-sm text-white/35 mb-6">
        ...
        <span>/</span>
        <span className="text-white">New Model</span>
      </nav>

      <div className="mb-8">
        <h1 className="text-2xl font-bold text-white">Create New Model</h1>
        <p className="text-white/35 mt-1">
          Fill in the details below. New models are hidden by default until you enable availability.
        </p>
      </div>
